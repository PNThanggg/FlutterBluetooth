  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          Center(
            child: Text('Bluetooth is ${_isBluetoothAvailable ? 'ON' : 'OFF'}'),
          ),
          // Column(
          //   crossAxisAlignment: CrossAxisAlignment.center,
          //   children: [
          ...
          Row(
            ...
            children: [
              ElevatedButton(
                style: ButtonStyle(
                  backgroundColor: MaterialStateProperty.all(_isBluetoothAvailable ? Colors.lightGreen : Colors.blue),
                ),
                onPressed: () async {
                  //call the function but as async but if function return null means the device doesn't support bluetooth
          ...
          Row(
            ...
            children: [
              ElevatedButton(
                onPressed: () async {
                  //call the function but as async bluetooth turn on
              ...
              ElevatedButton(
                onPressed: () async {
                  //call the function but as async bluetooth turn off
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  await blueConnect.connect(
                    macAddress: textEditingController.text,
                  );
                },
          ...
          Center(child: Text('Location permission is ${_isLocationAvailable ? 'ON' : 'OFF'}')),
          Center(
            child: Text('Location setting is ${_isLocationOn ? 'ON' : 'OFF'}'),
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              ...
              ElevatedButton(
                style:
                    ButtonStyle(backgroundColor: MaterialStateProperty.all(_isLocationOn ? Colors.lightGreen : Colors.blue)),
                onPressed: () async {
                  //call the function but as async
          ...
          Row(
            ...
            children: [
              ElevatedButton(
                ...
                child: const Text('Go Location Setting for Enable'),
              )
            ],
          ),
          Row(
          ...
          if (isLoading) const LinearProgressIndicator(color: Colors.orangeAccent),
          StreamBuilder(
          ...
          StreamBuilder(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                var device = BluetoothDevice.fromJson(jsonDecode(snapshot.data as String));
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ListTile(
                              ...
                              title: Text("${devices![index].name!} (${devices![index].aliasName!})"),
                                    ...
                                    child: ElevatedButton(
                                      style: ButtonStyle(
                                        ...
                                        backgroundColor: MaterialStateProperty.all(
                                          devices![index].isPaired! == "PAIRED" ? Colors.lightGreen : Colors.blue,
                                        ),
                                      ),
                                      onPressed: () async {
                                      ...
                                      child: Text(
                                        devices![index].isPaired! == "PAIRED" ? "C" : "P",
                                      ),
                                    ),
                                  ),
                                  const SizedBox(
                                      ...
                                      child: ElevatedButton(
                                        ...
                                        onPressed: () async {
                                          await blueConnect.write(
                                            data: "World is something, like something, yeah i know",
                                            autoConnect: true,
                                          );
                                        },
                                        child: const Text("W"),
